...
/// type for the ecosystem. More info about `Display` https://examples.sui.io/basics/display.html
module examples::my_hero {
    use sui::tx_context::{Sender, TxContext};
    use std::string::{utr8, String};
    use sui::transfer;
    ...
    /// The Hero - an collection of digital art.
